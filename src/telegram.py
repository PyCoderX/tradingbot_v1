...
from src import RestClient, TelegramCredentials
...
class TelegramBot:
    ...
    def sendMessage(self, text):
        ...
        inputs = {
            ...
            "params": {"chat_id": TelegramCredentials.personal_chat_id, "text": text},
        }
    ...
    def sendDocument(self, document_path, caption=""):
        ...
        try:
            inputs = {
                ...
                "params": {
                    "chat_id": TelegramCredentials.personal_chat_id,
                    "caption": caption,
                },
